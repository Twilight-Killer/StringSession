...
async def generate_session(bot: Client, msg: Message, telethon=False, old_pyro: bool = False, is_bot: bool = False):
    ...
    if not is_bot:
        t = "» Kirim `PHONE_NUMBER` dengan kode negara yang ingin Anda buat string session \nCONTOH : `+910000000000`'"
    else:
